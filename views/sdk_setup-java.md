...
```xml
<dependency org="cn.leancloud" name="storage-core" rev="8.1.5" />
```

SBT：

```scala
libraryDependencies += "cn.leancloud" %% "storage-core" % "8.1.5"
```
...
```xml
<dependency org="cn.leancloud" name="realtime-core" rev="8.1.5" />
```

SBT:

```scala
libraryDependencies += "cn.leancloud" %% "realtime-core" % "8.1.5"
```
