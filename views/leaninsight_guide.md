...
{% call docs.noteWrap() -%}
离线数据分析功能（**控制台** > **存储** > **结构化数据** >**离线数据分析**）**仅向华北节点的商用版和企业版应用开放**，开发版应用无法使用；如果商用版和企业版应用无法正常使用该功能，请通过 [工单系统](https://leanticket.cn/t/leancloud) 或 [用户论坛](https://forum.leancloud.cn) 联系我们。
{%- endcall %}
